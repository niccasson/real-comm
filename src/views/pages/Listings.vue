    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                            ...
                            <div v-for="(item, index) in slotProps.items" :key="index" class="col-12">
                                <div class="flex flex-column sm:flex-row sm:align-items-center p-4 gap-3" :class="{ 'border-top-1 surface-border': index !== 0 }">
                                    <div class="md:w-10rem relative">
                                        <img class="block xl:block mx-auto border-round w-full" :src="`https://real-comm-aws-bucket.s3.us-east-2.amazonaws.com/90s.jpg`" :alt="item.name" />
                                        <img v-if="`https://real-comm-aws-bucket.s3.us-east-2.amazonaws.com/90s.jpg`" :src="`https://primefaces.org/cdn/primevue/images/product/${item.image}`" alt="Loaded Image" />
                                ...
                                <div class="p-4 border-1 surface-border surface-card border-round flex flex-column">
                                    <div class="flex justify-content-center p-3">
                                        <div class="relative mx-auto">
                                            <img class="border-round w-full" :src="item.media" :alt="item.address" style="max-width: 300px"/>
                                            <!-- <Tag :value="item.inventoryStatus" :severity="getSeverity(item)" class="absolute" style="left: 4px; top: 4px"></Tag> -->
                                        </div>
                                    </div>
                                    <div class="pt-4">
                ...
                <!-- <div>
                    <img v-if="`https://real-comm-aws-bucket.s3.us-east-2.amazonaws.com/90s.jpg`" :src="`https://real-comm-aws-bucket.s3.us-east-2.amazonaws.com/90s.jpg`" alt="Loaded Image" />
                </div> -->
