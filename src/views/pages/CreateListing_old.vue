...
<template>
    <div class="card">
        <span class="block text-900 font-bold text-xl mb-4">Create Listing</span>
        <div class="grid grid-nogutter flex-wrap gap-3 p-fluid">
            <div class="col-12 lg:col-8">
                <div class="grid formgrid">
                    <div class="col-12 field">
                        <InputText type="text" placeholder="Address" v-model="product.name" />
                    </div>
                    <div class="col-12 lg:col-4 field">
                        <!-- <InputText type="text" placeholder="Price" label="Price" v-model="product.price" /> -->
                        <InputNumber v-model="product.price" placeholder="Enter the price" :min="0" />
                    </div>
                    <div class="col-12 lg:col-4 field">
